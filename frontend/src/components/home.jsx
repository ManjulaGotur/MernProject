            ...
            <div className="home1">
                <div className="image row ">
                    <div className="image col-lg-8 col-sm-12 p-0">
                        <img className="col-lg-8 col-sm-12 w-100" src="images/biriyani4.jpeg" alt="" />
                    </div>
            ...
            <section className="home3 row ">
                <div className="k1 col-lg-6 row  ">
                    <div className="k11 col-6">
                        <img src="/images/biriyani11.jpeg" width="300px" height="280px" alt="" />
                          <p>Tasty & Delicious Foods</p>
                        <a className="btn btn-light text-danger" href="">Read More   &rarr;</a>
                    </div>
                  
                    <div className="k12 col-6">
                        <img  src="/images/biriyani6.jpeg" width="300px" height="280px" alt="" />
                        <p>Tasty & Delicious Foods</p>
                        <a className="btn btn-light text-danger" href="">Read More   &rarr;</a>
                    </div>
                    <div className="k13 col-6">
                        <img  src="/images/biriyani7.jpeg" width="300px" height="280px" alt="" />
                        <p>Tasty & Delicious Foods</p>
                        <a className="btn btn-light text-danger" href="">Read More   &rarr;</a>
                    </div>
                    <div className="k14 col-6">
                        <img  src="/images/biriyani12.jpeg" width="300px" height="280px" alt="" />
                        <p>Tasty & Delicious Foods</p>
                        <a className="btn btn-light text-danger" href="">Read More   &rarr;</a>
                    </div>
                </div>
